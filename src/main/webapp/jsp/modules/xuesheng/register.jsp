...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<div class="item-label">学生账号</div> 
					<input  name="xueshengzhanghao"  placeholder="请输入学生账号" class="form-control-i">
				</div>
				<div class="list-item">
				...
				<div class="list-item">
					...
					<input  name="lianxifangshi"  placeholder="请输入联系方式" class="form-control-i">
				</div>
				<div class="list-item">
					<div class="item-label">籍贯</div> 
					<input  name="jiguan"  placeholder="请输入籍贯" class="form-control-i">
				</div>
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
        ...
        function banjimingchengSelect(){
            http("option/banjixinxi/banjimingcheng","GET",{},(res)=>{
                if(res.code == 0){
