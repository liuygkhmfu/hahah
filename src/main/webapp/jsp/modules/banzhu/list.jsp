...
<body>
	<div id="main-container">
		...
		<div id="breadcrumb-container">
			<h3 class="breadcrumb-title">班助管理</h3>
			<ol class="breadcrumb-list">
				...
				<li class="breadcrumb-item-one"><span>班助管理</span></li>
				<li class="breadcrumb-item-two"><span>班助列表</span></li>
			</ol>
		</div>
		<!-- /Breadcrumb -->
		...
		<div id="center-container">
			...
			<div class="center-form">
				<div class="form-item">
					<label>班助账号</label>
					<input type="text" id="banzhuzhanghaoSearch" class="form-control form-control-sm" placeholder="请输入班助账号" aria-controls="tableId">
				</div>
				<div class="form-item">
					<label>班助姓名</label>
					<input type="text" id="banzhuxingmingSearch" class="form-control form-control-sm" placeholder="请输入班助姓名" aria-controls="tableId">
				</div>
	...
	<script>
		...
		function search(){
			searchForm = { key: ""};
			if($('#banzhuzhanghaoSearch').val() != null && $('#banzhuzhanghaoSearch').val() != ''){
				searchForm.banzhuzhanghao ="%" +  $('#banzhuzhanghaoSearch').val() + "%";
			}
			
			if($('#banzhuxingmingSearch').val() != null && $('#banzhuxingmingSearch').val() != ''){
				searchForm.banzhuxingming ="%" +  $('#banzhuxingmingSearch').val() + "%";
			}
        ...
        function getDataList() {
			http("banzhu/page","GET",{
				page: pageIndex,
				limit: pageSize,
				sort: sortColumn,
				order: sortOrder,
				banzhuzhanghao : searchForm.banzhuzhanghao,	
				banzhuxingming : searchForm.banzhuxingming,	
			},(res)=>{
				if(res.code == 0){
					clear();
        ...
        function remove(id) { 
            ...
            if (mymessage == true) {
				...
				httpJson("banzhu/delete","POST",paramArray,(res)=>{
					if(res.code == 0){
						getDataList();		
						alert('删除成功');
					}
	...
	function crossTable(obj,crossTableName,crossOptAudit,statusColumnName,tips,statusColumnValue){
		...
		window.sessionStorage.setItem('crossTableName',"banzhu");
