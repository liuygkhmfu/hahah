...
<body>
	...
	<div class="content">
			<form id="registerForm" action="" method="post">
				...
				<div class="list-item">
					<div class="item-label">班助账号</div> 
					<input  name="banzhuzhanghao"  placeholder="请输入班助账号" class="form-control-i">
				</div>
				<div class="list-item">
				...
				<div class="list-item">
					<div class="item-label">班助姓名</div> 
					<input  name="banzhuxingming"  placeholder="请输入班助姓名" class="form-control-i">
				</div>
                <div class="list-item">
	...
	<%@ include file="../../utils/baseUrl.jsp"%>
		...
		function submit() {
			if(validform() ==true){
				...
				var url = baseUrl + "banzhu/register";
				$.ajax({ 
					type: "POST",
					url: url,
