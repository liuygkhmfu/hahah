...
public class BaodaoxinxiServiceImpl extends ServiceImpl<BaodaoxinxiDao, BaodaoxinxiEntity> implements BaodaoxinxiService {
    ...
    @Override
    public List<Map<String, Object>> selectValue(Map<String, Object> params, Wrapper<BaodaoxinxiEntity> wrapper) {
        return baseMapper.selectValue(params, wrapper);
    }

    @Override
    public List<Map<String, Object>> selectTimeStatValue(Map<String, Object> params, Wrapper<BaodaoxinxiEntity> wrapper) {
        return baseMapper.selectTimeStatValue(params, wrapper);
    }
    
    @Override
    public List<Map<String, Object>> selectGroup(Map<String, Object> params, Wrapper<BaodaoxinxiEntity> wrapper) {
        return baseMapper.selectGroup(params, wrapper);
    }


    @Override
    public List<Map<String, Object>> xueshengxingmingbaodaozhuangtaiTypeStat(Map<String, Object> params, Wrapper<BaodaoxinxiEntity> wrapper) {
        return baseMapper.xueshengxingmingbaodaozhuangtaiTypeStat(params, wrapper);
    }
