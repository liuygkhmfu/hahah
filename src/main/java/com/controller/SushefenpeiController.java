...
public class SushefenpeiController {
    ...
    public R page(@RequestParam Map<String, Object> params,SushefenpeiEntity sushefenpei, 
		...
		if(tableName.equals("xuesheng")) {
			sushefenpei.setXueshengzhanghao((String)request.getSession().getAttribute("username"));
		}
		if(tableName.equals("banzhu")) {
			sushefenpei.setBanzhuzhanghao((String)request.getSession().getAttribute("username"));
		}
