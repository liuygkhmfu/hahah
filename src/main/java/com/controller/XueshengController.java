        ...
        try {
            ...
            if(rows>1){
                ...
                for (int i = 1; i < rows; i++) {
                    ...
                    String xueshengzhanghao = CommonUtil.getCellValue(row.getCell(0));
                    xueshengEntity.setXueshengzhanghao(xueshengzhanghao);
                    ...
                    String banjimingcheng = CommonUtil.getCellValue(row.getCell(4));
                    xueshengEntity.setBanjimingcheng(banjimingcheng);
                    String lianxifangshi = CommonUtil.getCellValue(row.getCell(5));
                    xueshengEntity.setLianxifangshi(lianxifangshi);
                    String jiguan = CommonUtil.getCellValue(row.getCell(6));
                    xueshengEntity.setJiguan(jiguan);
