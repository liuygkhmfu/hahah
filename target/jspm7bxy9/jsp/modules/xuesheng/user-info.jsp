	...
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>学生账号</label>
					<input name="xueshengzhanghao" readonly id="xueshengzhanghao" name="xueshengzhanghao" class="form-control" placeholder="请输入学生账号">
				</div>
				<div class="form-item">
					<label>学生姓名</label>
				...
				<div class="form-item">
					<label>籍贯</label>
					<input name="jiguan"  id="jiguan" name="jiguan" class="form-control" placeholder="请输入籍贯">
				</div>
