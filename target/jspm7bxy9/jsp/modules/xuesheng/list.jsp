...
<div id="main-container">
	...
	<div id="center-container">
		...
		<div class="btns">
			...
			<button onclick="deleteMore()" type="button" class="btn btn-success btn-add 新增"><i class="fa fa-remove"></i><span>批量删除</span></button>
			...
			<button type="button" class="btn btn-success btn-export 导入" data-target="#importExampleModal" data-toggle="modal"><i class="fa fa-file-excel-o"></i><span>导入</span></button>
		</div>
	...
	<script>
		...
		function importExcel() {
			$('#excelfileupload').fileupload({
				url: baseUrl + 'xuesheng/importExcel',
