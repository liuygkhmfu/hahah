	...
	<div id="main-container">
		...
		<div id="add-container">
			<form id="addOrUpdateForm">
				...
				<div class="form-item">
					<label>班助账号</label>
					<input name="banzhuzhanghao" readonly id="banzhuzhanghao" name="banzhuzhanghao" class="form-control" placeholder="请输入班助账号">
				</div>
				<div class="form-item">
					<label>班助姓名</label>
	...
	<script>
		...
		function submit() {
			...
			if(validform() ==true && compare() == true){
				...
				httpJson("banzhu/"+urlParam,"POST",data,(res)=>{
					if(res.code == 0){
